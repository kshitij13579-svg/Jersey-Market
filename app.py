...
# ── Page Config ─────────────────────────────────────────────
st.set_page_config(page_title="Jersey Marketplace Analytics", page_icon=":trophy:", layout="wide", initial_sidebar_state="expanded")
...
<style>
    ...
    /* Sidebar collapse button — hide garbled text */
    [data-testid="stSidebarCollapseButton"] button span { font-size: 0 !important; }
    [data-testid="stSidebarCollapseButton"] button svg { width: 20px; height: 20px; }

    /* Multiselect tag styling — gold on dark instead of red */
    ...
    span[data-baseweb="tag"] span { color: var(--bg) !important; }
